...
$slotStmt = $pdo->prepare("SELECT * FROM event_time_slots WHERE event_id = ?");
$slotStmt->execute([$id]);
$slots = $slotStmt->fetchAll();
?>
<div class="space-y-6">
    <a href="/student/index.php" class="flex items-center gap-2 text-xs font-bold text-gray-600">
